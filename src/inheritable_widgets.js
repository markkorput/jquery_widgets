// this methodology and the actual function are copied from this post:
// http://bililite.com/blog/extending-jquery-ui-widgets/

(function($){

// general class inheritance helper
var object = (function(){
    function F(){}
    return (function(o){
        F.prototype = o;
...
// create an empty base widget, which we'll fill with inheritance logic
$.widget('ui.basewidget');

// add inheritance logic to the base widget, which can be used (and passed on) through the following construction:
// $.ui.widget.subclass('ui.advancedwidget', { ... });
var OVERRIDE = /xyz/.test(function(){xyz;}) ? /\b_super\b/ : /.*/; 

$.ui.basewidget.subclass = function subclass (name){
